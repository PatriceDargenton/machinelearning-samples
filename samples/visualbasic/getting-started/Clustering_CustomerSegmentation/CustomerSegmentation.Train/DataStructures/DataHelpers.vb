...
Namespace CustomerSegmentation.DataStructures
    ...
    Public Class DataHelpers
        ...
        Public Shared Function PreProcessAndSave(offersDataLocation As String,
                transactionsDataLocation As String,
                pivotDataLocation As String) As IEnumerable(Of PivotData)
        ...
        Public Shared Function PreProcess(offersDataLocation As String,
                transactionsDataLocation As String) As IEnumerable(Of PivotData)
